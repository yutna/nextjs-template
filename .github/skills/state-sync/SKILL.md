...
If the plan draft changes, mirror the same content into `src/tmp/PLAN.md` in the repository and keep it gitignored.
...
- keep the local plan mirror at `src/tmp/PLAN.md` current so the user can inspect the latest plan from the repository workspace
